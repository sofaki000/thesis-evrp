...
def arg_parser():
    ...
    parser.add_argument('-n', '--n_customer', metavar='N', type=int, default=4,
                        help='number of customer nodes, time sequence')

    # train config
    parser.add_argument('-b', '--batch', metavar='B', type=int, default=10, help='batch size')
    parser.add_argument('-bs', '--batch_steps', metavar='BS', type=int, default=25,
