...
from datasets.CVRP_dataset import VehicleRoutingDataset
from ploting.metrics.plot_average_tour_length import plot_average_tour_length
from ploting.plot_utilities import plot_train_and_validation_loss, plot_train_loss_and_train_reward

train_size = 100000  # 0#000  # 1000000
batch_size = 256
...
class Pointer(nn.Module):
    ...
    def __init__(self, hidden_size, num_layers=1, dropout=0.2):
        ...
        self.decoderOutputToProbabilities = nn.Linear(hidden_size, seq_len+1)
    ...
    def forward(self, static_hidden, dynamic_hidden, decoder_hidden, last_hh):
        ...
        real_probs = self.decoderOutputToProbabilities(rnn_out)
        # TODO: instead of decoderOutputToProbabilities
...
def train(actor,  task, num_nodes, train_data, valid_data, reward_fn,
    ...
    loss_at_epoch = []
    reward_at_epoch = []
    average_tour_length_validation_data = []
    ...
    for epoch in range(epochs):
        ...
        average_tour_length_validation_data.append(mean_valid)
    ...
    plot_train_loss_and_train_reward(epoch,
                                     ...
                                     experiment_details,
                                     "classicSeqToSeqCVRP")
    plot_average_tour_length(average_tour_length_validation_data, experiment_details)
...
if __name__ == '__main__':
    ...
    experiment_details =  f'seq2seqCVRP_epoch{epochs}_trainSize{train_size}_bs{batch_size}_valSize{validation_size}_hidden{hidden_size}_lr{lr}'
